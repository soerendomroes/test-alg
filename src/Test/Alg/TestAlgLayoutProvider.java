...
import Test.Alg.options.TestAlgOptions;

/**
 * A simple layout algorithm class. This algorithm already supports a number of layout options, places nodes, and
 * routes edges.
 */
public class TestAlgLayoutProvider extends AbstractLayoutProvider {

    @Override
    public void layout(ElkNode layoutGraph, IElkProgressMonitor progressMonitor) {
        // Start progress monitor
        progressMonitor.begin("TestAlg", 2);
...
//        double nodeNodeSpacing = layoutGraph.getProperty(TestAlgOptions.SPACING_NODE_NODE);
        ...
        if (layoutGraph.getProperty(TestAlgOptions.REVERSE_INPUT)) {
